...
<body>
    <div class="container h-100">
        <div class="container">
            <h1 id="form-title" style="text-align: center; color: #204081; font-weight: bold; margin-top:40px" >SYSTEM</h1>
        </div>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <div class="d-flex justify-content-center mt-3 login_container">
                                <input class="btn login_btn" type="submit"  name="login" value="Login">
                            </div>
                    </form>
